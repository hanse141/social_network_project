        	...
        	*/
            ...
            while (gui.isRunning()) {
            	...
            	if(loggedIn) { 
	            	...
	            	if(gui.newConversation() != null) {
	                	String newConvo = gui.newConversation();
	                	commandToSend = "nc " + newConvo + " " + user.getUsername();
	    	       	...
	    	       	if(gui.loadConversation() != null) {
	                	...
	                	recipient = gui.loadConversation();
	                ...
	                if(gui.deleteAccount() != null) {
	                	...
	                	if(inputtedPass.equals(user.getPassword())) {
	    	           		commandToSend = "du " + user.getUsername() + " " + user.getPassword();
	                ...
	                if(gui.exportConversation() != null) {
	                	commandToSend = "xc " + gui.exportConversation() + " " + user.getUsername();
               ...
               // command = scan.nextLine();
                ...
                //if(command.length() > 2 && command.substring(0,2).equals("du"))
                //	Thread.sleep(2000);
